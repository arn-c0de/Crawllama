...
## Search Operators Reference | Operator | Purpose | Example |
|----------|---------|---------|
...
### Supported Platforms | Platform | Check Methods | Data Extracted |
|----------|---------------|----------------|
...
### Features | Feature | Description | Example |
|---------|-------------|---------|
...
### Rate Limits (Per Hour) | Query Type | Limit |
|------------|-------|
| Email searches | 50 |
| Phone searches | 50 |
| General OSINT | 100 |
...
## All Features Summary (5 Intelligence Types) | Feature | Operator | Data Sources | Validation | AI Enhancement |
|---------|----------|--------------|------------|----------------|
...
**Remember:** Use OSINT features responsibly and ethically! 
