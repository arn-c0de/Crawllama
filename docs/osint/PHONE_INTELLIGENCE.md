...
│ • Normalize to E.164 format (+4943219900000) │
...
- `phone:04321/99 00 000` - With slashes
...
| `04321/99 00 000` | DE | German area code (4321) |
...
remember_phone("04321/99 00 000") # → +4943219900000
remember_phone("043219900000") # → +4943219900000 (duplicate!)
remember_phone("+4943219900000") # → +4943219900000 (duplicate!)
remember_phone("+49 4321 9900000") # → +4943219900000 (duplicate!)
...
```python
# 1. Parse query
parsed = parser.parse(query) # phone:04321/99 00 000
...
**Input:** `phone:04321/99 00 000`

**Analysis:**
- Country: Musterstadt (Germany)
- Type: fixed_line → "landline"
- Formatted: +49 4321 9900000

**Generated Queries:**
1. `Musterstadt landline +49 4321 9900000`
2. `"043219900000" contact`
...
phone:04321/99 00 000 # German with slash
